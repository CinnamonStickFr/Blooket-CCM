...
(() => {
    ...
    const cheat = (async () => {
        ...
        credit.innerText = "Coded By Lime";
        ...
        version.innerText = "CCMV1  - Crimson Cheat Menu V1.0.0";
